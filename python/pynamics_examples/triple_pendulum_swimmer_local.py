...
wCx,wCx_d = Differentiable('wCx',ii = 1,limit=3)
wCy,wCy_d = Differentiable('wCy',ii = 1,limit=3)
wCz,wCz_d = Differentiable('wCz',ii = 1,limit=3)
...
initialvalues[qB]=small
initialvalues[qB_d]=small
initialvalues[qC]=small
...
eq1 = wC1-wC2
eq.append(eq1.dot(B2.x))
eq.append(eq1.dot(B2.y))
eq.append(eq1.dot(B2.z))

system.add_constraint(DynamicConstraint(eq,[wAx,wAy,wAz,wCz,wCx],[qA1_d,qA2_d,qA3_d,qC_d,qB_d,wCy]))
