...
states=pynamics.integration.integrate_odeint(func1,ini1,t,rtol=tol,atol=tol,args=({'constants':constants},))
...
points_output.animate(fps = 30, movie_name='parallel_five_bar_jumper.mp4',lw=2)
