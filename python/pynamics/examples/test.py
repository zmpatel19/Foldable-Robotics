...
#    a,b,c,d,e,f,q = sympy.symbols('a b c d e f q')
    qA,qA_d,qA_dd = Differentiable(sys,'qA')
    qB,qB_d,qB_dd = Differentiable(sys,'qB')
    qC,qC_d,qC_dd = Differentiable(sys,'qC')
    qD,qD_d,qD_dd = Differentiable(sys,'qD')
    qE,qE_d,qE_dd = Differentiable(sys,'qE')
