...
l = Constant('l',1,system)
m = Constant('m',1,system)
n = Constant('n',1,system)
o = Constant('o',0,system)
p = Constant('p',0,system)
...
pO=0*N.x
pAcm = x*N.x+y*N.y
pAB = pAcm + o*A.x+p*A.y
pAfront = pAcm+m*A.x-n*A.y
pAback = pAcm-m*A.x-n*A.y
pBcm = pAB+l/2*B.x
pBcontact = pAB+l*B.x
